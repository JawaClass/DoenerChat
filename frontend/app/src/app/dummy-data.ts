...
export const menuItems: MenuItem[] = [
  // DÖNER & WRAPS
  { id: 1, name: "Döner", category: "fastfood", price: 6.00, currency: "EUR", available: true, preparationTime: 5, calories: 850 },
  { id: 2, name: "Döner mit Käse", category: "fastfood", price: 6.50, currency: "EUR", available: true, preparationTime: 6, calories: 950 },
  { id: 3, name: "Doppel Döner", category: "fastfood", price: 9.00, currency: "EUR", available: true, preparationTime: 7, calories: 1400 },
  { id: 4, name: "Vegetarischer Döner", category: "fastfood", price: 5.50, currency: "EUR", available: true, preparationTime: 5, calories: 550 },
  { id: 5, name: "Hähnchen Döner", category: "fastfood", price: 6.00, currency: "EUR", available: true, preparationTime: 5, calories: 720 },
  { id: 6, name: "Döner Box", category: "fastfood", price: 7.50, currency: "EUR", available: true, preparationTime: 8, calories: 980 },
  { id: 7, name: "Wrap Classic", category: "fastfood", price: 5.50, currency: "EUR", available: true, preparationTime: 5, calories: 620 },
  { id: 8, name: "Wrap Hähnchen", category: "fastfood", price: 5.50, currency: "EUR", available: true, preparationTime: 5, calories: 580 },
  { id: 9, name: "Lahmacun", category: "fastfood", price: 4.50, currency: "EUR", available: true, preparationTime: 6, calories: 480 },
  { id: 10, name: "Lahmacun mit Salat", category: "fastfood", price: 5.00, currency: "EUR", available: true, preparationTime: 6, calories: 520 },

  // PIZZA
  { id: 11, name: "Pizza Margherita", category: "pizza", price: 7.00, currency: "EUR", available: true, preparationTime: 12, calories: 720 },
  { id: 12, name: "Pizza Salami", category: "pizza", price: 8.00, currency: "EUR", available: true, preparationTime: 12, calories: 870 },
  { id: 13, name: "Pizza Thunfisch", category: "pizza", price: 8.50, currency: "EUR", available: true, preparationTime: 12, calories: 780 },
  { id: 14, name: "Pizza Vegetarisch", category: "pizza", price: 8.00, currency: "EUR", available: true, preparationTime: 12, calories: 680 },
  { id: 15, name: "Pizza Calzone", category: "pizza", price: 9.00, currency: "EUR", available: true, preparationTime: 15, calories: 950 },
  { id: 16, name: "Pizza Hähnchen", category: "pizza", price: 9.00, currency: "EUR", available: true, preparationTime: 12, calories: 820 },
  { id: 17, name: "Pizza Spezial", category: "pizza", price: 10.00, currency: "EUR", available: true, preparationTime: 14, calories: 1020 },

  // BURGER
  { id: 18, name: "Classic Burger", category: "burger", price: 7.00, currency: "EUR", available: true, preparationTime: 10, calories: 650 },
  { id: 19, name: "Cheeseburger", category: "burger", price: 7.50, currency: "EUR", available: true, preparationTime: 10, calories: 720 },
  { id: 20, name: "Doppel Cheeseburger", category: "burger", price: 10.00, currency: "EUR", available: true, preparationTime: 12, calories: 1100 },
  { id: 21, name: "Hähnchen Burger", category: "burger", price: 7.50, currency: "EUR", available: true, preparationTime: 10, calories: 580 },
  { id: 22, name: "Veggie Burger", category: "burger", price: 7.00, currency: "EUR", available: false, preparationTime: 10, calories: 490 },
  { id: 23, name: "BBQ Burger", category: "burger", price: 8.50, currency: "EUR", available: true, preparationTime: 11, calories: 850 },

  // BEILAGEN
  { id: 24, name: "Pommes klein", category: "sides", price: 2.50, currency: "EUR", available: true, preparationTime: 5, calories: 320 },
  { id: 25, name: "Pommes groß", category: "sides", price: 3.50, currency: "EUR", available: true, preparationTime: 5, calories: 520 },
  { id: 26, name: "Pommes mit Soße", category: "sides", price: 3.00, currency: "EUR", available: true, preparationTime: 5, calories: 420 },
  { id: 27, name: "Onion Rings", category: "sides", price: 3.00, currency: "EUR", available: true, preparationTime: 6, calories: 380 },
  { id: 28, name: "Coleslaw", category: "sides", price: 2.00, currency: "EUR", available: true, preparationTime: 1, calories: 150 },
  { id: 29, name: "Salat", category: "sides", price: 2.50, currency: "EUR", available: true, preparationTime: 3, calories: 80 },
  { id: 30, name: "Knoblauchbrot", category: "sides", price: 2.00, currency: "EUR", available: true, preparationTime: 4, calories: 260 },

  // SAUCEN
  { id: 31, name: "Knoblauchsoße", category: "sauces", price: 0.50, currency: "EUR", available: true, preparationTime: 0, calories: 90 },
  { id: 32, name: "Scharf Soße", category: "sauces", price: 0.50, currency: "EUR", available: true, preparationTime: 0, calories: 20 },
  { id: 33, name: "Ketchup", category: "sauces", price: 0.30, currency: "EUR", available: true, preparationTime: 0, calories: 30 },
  { id: 34, name: "Mayonnaise", category: "sauces", price: 0.30, currency: "EUR", available: true, preparationTime: 0, calories: 130 },
  { id: 35, name: "BBQ Soße", category: "sauces", price: 0.50, currency: "EUR", available: true, preparationTime: 0, calories: 50 },

  // GETRÄNKE
  { id: 36, name: "Coca Cola", category: "drinks", price: 1.90, currency: "EUR", available: true, preparationTime: 0, calories: 140 },
  { id: 37, name: "Coca Cola Zero", category: "drinks", price: 1.90, currency: "EUR", available: true, preparationTime: 0, calories: 2 },
  { id: 38, name: "Fanta", category: "drinks", price: 1.90, currency: "EUR", available: true, preparationTime: 0, calories: 150 },
  { id: 39, name: "Sprite", category: "drinks", price: 1.90, currency: "EUR", available: true, preparationTime: 0, calories: 130 },
  { id: 40, name: "Ayran", category: "drinks", price: 1.50, currency: "EUR", available: true, preparationTime: 0, calories: 60 },
  { id: 41, name: "Wasser still", category: "drinks", price: 1.20, currency: "EUR", available: true, preparationTime: 0, calories: 0 },
  { id: 42, name: "Wasser sprudelnd", category: "drinks", price: 1.20, currency: "EUR", available: true, preparationTime: 0, calories: 0 },
  { id: 43, name: "Apfelsaft", category: "drinks", price: 1.80, currency: "EUR", available: true, preparationTime: 0, calories: 110 },
  { id: 44, name: "Orangensaft", category: "drinks", price: 1.80, currency: "EUR", available: true, preparationTime: 0, calories: 100 },
  { id: 45, name: "Tee", category: "drinks", price: 1.50, currency: "EUR", available: true, preparationTime: 2, calories: 5 },
  { id: 46, name: "Kaffee", category: "drinks", price: 2.00, currency: "EUR", available: true, preparationTime: 3, calories: 10 },
  { id: 47, name: "Çay (türkischer Tee)", category: "drinks", price: 1.20, currency: "EUR", available: true, preparationTime: 3, calories: 5 },

  // DESSERTS
  { id: 48, name: "Baklava (2 Stück)", category: "desserts", price: 3.00, currency: "EUR", available: true, preparationTime: 1, calories: 380 },
  { id: 49, name: "Künefe", category: "desserts", price: 4.50, currency: "EUR", available: false, preparationTime: 8, calories: 520 },
  { id: 50, name: "Softeis", category: "desserts", price: 2.00, currency: "EUR", available: true, preparationTime: 2, calories: 220 },
];
// ----------------------------
// KATEGORIEN
// ----------------------------
