package com.doener.doener.features.foodMenu.foodMenuMeal;
...
@Entity
@Table(name = "food_menu_meals", uniqueConstraints = @UniqueConstraint(columnNames = { "food_menu_id", "meals_id" }))
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@EqualsAndHashCode(callSuper = true)
public class FoodMenuMeal extends TableDefaultEntity {
